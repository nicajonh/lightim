...
type LogicForConnServer struct{}

// SignIn 设备登录
func (*LogicForConnServer) SignIn(ctx context.Context, req *pb.SignInReq) (*pb.SignInResp, error) {
	return &pb.SignInResp{}, service.AuthService.SignIn(ctx, req.AppId, req.UserId, req.DeviceId, req.Token, req.ConnAddr)
}

// Sync 设备同步消息
func (*LogicForConnServer) Sync(ctx context.Context, req *pb.SyncReq) (*pb.SyncResp, error) {
...
func (*LogicForConnServer) MessageACK(ctx context.Context, req *pb.MessageACKReq) (*pb.MessageACKResp, error) {
	return &pb.MessageACKResp{}, service.DeviceAckService.Update(ctx, req.DeviceId, req.DeviceAck)
}

// Offline 设备离线
func (*LogicForConnServer) Offline(ctx context.Context, req *pb.OfflineReq) (*pb.OfflineResp, error) {
